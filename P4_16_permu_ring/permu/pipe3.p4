...
parser Pipe3SwitchIngressParser(
        packet_in pkt,
        out pipe3_header_t hdr,
...
control Pipe3SwitchIngressDeparser(
        packet_out pkt,
        inout pipe3_header_t hdr,
        in metadata_t ig_md,
...
control Pipe3SwitchIngress(
    ...
    table cluster0_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000001 : cluster0_bit0_1_action();
        }
        size = 2;
    }
    ...
    table cluster1_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000002 : cluster1_bit0_1_action();
        }
        size = 2;
    }    
    ...
    table cluster2_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000004 : cluster2_bit0_1_action();
        }
        size = 2;
    }    
    ...
    table cluster3_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000008 : cluster3_bit0_1_action();
        }
        size = 2;
    }
    ...
    table cluster4_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000010 : cluster4_bit0_1_action();
        }
        size = 2;
    }
    ...
    table cluster5_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000020 : cluster5_bit0_1_action();
        }
        size = 2;
    }
    ...
    table cluster6_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000040 : cluster6_bit0_1_action();
        }
        size = 2;
    }
    ...
    table cluster7_bit0 {
        ...
        const entries = {
            ...
            0xffffffff &&& 0x00000080 : cluster7_bit0_1_action();
        }
        size = 2;
    }
    ...
    action cluster0_bit11_0_action() {
        cluster0_t tmp = hdr.group0.data0;
        hdr.group0.data0 = hdr.group1.data0;
        hdr.group1.data0 = hdr.group2.data0;
        hdr.group2.data0 = hdr.group3.data0;
    ...
    action cluster0_bit11_1_action() {
        cluster0_t tmp = hdr.group15.data0;
        hdr.group15.data0 = hdr.group14.data0;
        hdr.group14.data0 = hdr.group13.data0;
        hdr.group13.data0 = hdr.group12.data0;
    ...
    table cluster0_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster0_bit11_0_action;
            cluster0_bit11_1_action;
        }
        const default_action = cluster0_bit11_0_action;
        const entries = {
            32w0 &&& 0x01000000 : cluster0_bit11_0_action();
            0xffffffff &&& 0x01000000 : cluster0_bit11_1_action();
        }
        size = 2;
    }

    action cluster1_bit11_0_action() {
        cluster1_t tmp = hdr.group0.data1;
        hdr.group0.data1 = hdr.group1.data1;
        hdr.group1.data1 = hdr.group2.data1;
        hdr.group2.data1 = hdr.group3.data1;
    ...
    action cluster1_bit11_1_action() {
        cluster1_t tmp = hdr.group15.data1;
        hdr.group15.data1 = hdr.group14.data1;
        hdr.group14.data1 = hdr.group13.data1;
        hdr.group13.data1 = hdr.group12.data1;
    ...
    table cluster1_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster1_bit11_0_action;
            cluster1_bit11_1_action;
        }
        const default_action = cluster1_bit11_0_action;
        const entries = {
            32w0 &&& 0x02000000 : cluster1_bit11_0_action();
            0xffffffff &&& 0x02000000 : cluster1_bit11_1_action();
        }
        size = 2;
    }    

    action cluster2_bit11_0_action() {
        cluster2_t tmp = hdr.group0.data2;
        hdr.group0.data2 = hdr.group1.data2;
        hdr.group1.data2 = hdr.group2.data2;
        hdr.group2.data2 = hdr.group3.data2;
    ...
    action cluster2_bit11_1_action() {
        cluster2_t tmp = hdr.group15.data2;
        hdr.group15.data2 = hdr.group14.data2;
        hdr.group14.data2 = hdr.group13.data2;
        hdr.group13.data2 = hdr.group12.data2;
    ...
    table cluster2_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster2_bit11_0_action;
            cluster2_bit11_1_action;
        }
        const default_action = cluster2_bit11_0_action;
        const entries = {
            32w0 &&& 0x04000000 : cluster2_bit11_0_action();
            0xffffffff &&& 0x04000000 : cluster2_bit11_1_action();
        }
        size = 2;
    }    

    action cluster3_bit11_0_action() {
        cluster3_t tmp = hdr.group0.data3;
        hdr.group0.data3 = hdr.group1.data3;
        hdr.group1.data3 = hdr.group2.data3;
        hdr.group2.data3 = hdr.group3.data3;
    ...
    action cluster3_bit11_1_action() {
        cluster3_t tmp = hdr.group15.data3;
        hdr.group15.data3 = hdr.group14.data3;
        hdr.group14.data3 = hdr.group13.data3;
        hdr.group13.data3 = hdr.group12.data3;
    ...
    table cluster3_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster3_bit11_0_action;
            cluster3_bit11_1_action;
        }
        const default_action = cluster3_bit11_0_action;
        const entries = {
            32w0 &&& 0x08000000 : cluster3_bit11_0_action();
            0xffffffff &&& 0x08000000 : cluster3_bit11_1_action();
        }
        size = 2;
    }

    action cluster4_bit11_0_action() {
        cluster4_t tmp = hdr.group0.data4;
        hdr.group0.data4 = hdr.group1.data4;
        hdr.group1.data4 = hdr.group2.data4;
        hdr.group2.data4 = hdr.group3.data4;
    ...
    action cluster4_bit11_1_action() {
        cluster4_t tmp = hdr.group15.data4;
        hdr.group15.data4 = hdr.group14.data4;
        hdr.group14.data4 = hdr.group13.data4;
        hdr.group13.data4 = hdr.group12.data4;
    ...
    table cluster4_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster4_bit11_0_action;
            cluster4_bit11_1_action;
        }
        const default_action = cluster4_bit11_0_action;
        const entries = {
            32w0 &&& 0x10000000 : cluster4_bit11_0_action();
            0xffffffff &&& 0x10000000 : cluster4_bit11_1_action();
        }
        size = 2;
    }

    action cluster5_bit11_0_action() {
        cluster5_t tmp = hdr.group0.data5;
        hdr.group0.data5 = hdr.group1.data5;
        hdr.group1.data5 = hdr.group2.data5;
        hdr.group2.data5 = hdr.group3.data5;
    ...
    action cluster5_bit11_1_action() {
        cluster5_t tmp = hdr.group15.data5;
        hdr.group15.data5 = hdr.group14.data5;
        hdr.group14.data5 = hdr.group13.data5;
        hdr.group13.data5 = hdr.group12.data5;
    ...
    table cluster5_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster5_bit11_0_action;
            cluster5_bit11_1_action;
        }
        const default_action = cluster5_bit11_0_action;
        const entries = {
            32w0 &&& 0x20000000 : cluster5_bit11_0_action();
            0xffffffff &&& 0x20000000 : cluster5_bit11_1_action();
        }
        size = 2;
    }

    action cluster6_bit11_0_action() {
        cluster6_t tmp = hdr.group0.data6;
        hdr.group0.data6 = hdr.group1.data6;
        hdr.group1.data6 = hdr.group2.data6;
        hdr.group2.data6 = hdr.group3.data6;
    ...
    action cluster6_bit11_1_action() {
        cluster6_t tmp = hdr.group15.data6;
        hdr.group15.data6 = hdr.group14.data6;
        hdr.group14.data6 = hdr.group13.data6;
        hdr.group13.data6 = hdr.group12.data6;
    ...
    table cluster6_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster6_bit11_0_action;
            cluster6_bit11_1_action;
        }
        const default_action = cluster6_bit11_0_action;
        const entries = {
            32w0 &&& 0x40000000 : cluster6_bit11_0_action();
            0xffffffff &&& 0x40000000 : cluster6_bit11_1_action();
        }
        size = 2;
    }

    action cluster7_bit11_0_action() {
        cluster7_t tmp = hdr.group0.data7;
        hdr.group0.data7 = hdr.group1.data7;
        hdr.group1.data7 = hdr.group2.data7;
        hdr.group2.data7 = hdr.group3.data7;
    ...
    action cluster7_bit11_1_action() {
        cluster7_t tmp = hdr.group15.data7;
        hdr.group15.data7 = hdr.group14.data7;
        hdr.group14.data7 = hdr.group13.data7;
        hdr.group13.data7 = hdr.group12.data7;
    ...
    table cluster7_bit11 {
        key = {
            ig_md.key.code2 : ternary;
        }

        actions = {
            cluster7_bit11_0_action;
            cluster7_bit11_1_action;
        }
        const default_action = cluster7_bit11_0_action;
        const entries = {
            32w0 &&& 0x80000000 : cluster7_bit11_0_action();
            0xffffffff &&& 0x80000000 : cluster7_bit11_1_action();
        }
        size = 2;
    }
